...
from outlines.processors import OutlinesLogitsProcessor, CFGLogitsProcessor
...
class CLMCFGLogitsProcessor(CFGLogitsProcessor):        # this is not parallelized at all, could we improve this?  

    def __init__(self, cfg_str: str, tokenizer, llm):
        super().__init__(cfg_str, tokenizer)
        self.llm = llm
